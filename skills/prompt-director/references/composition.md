...
> 溯源：[info-2892](https://www.super-i.cn/info-2892.html)（2026-06 站更）
> 视觉标注修正 → [edit-fusion.md](edit-fusion.md) §44

**分工：** 文字告诉 AI「画什么」；草图告诉 AI「怎么摆」。

### 草图须回答的两问

| 问题 | 画什么 |
|------|--------|
| 人物在做什么 | 身体朝向、手脚动作、道具指向；近大远小表达透视 |
| 东西怎样摆放 | 左右站位、远近层次、坐/站/遮挡关系 |

**多对象：** 用固定颜色区分元素（黑=人物 A，红=椅子）；同图内颜色含义勿变。
...
|------|------|
| 草图 | 动作、站位、构图 |
| 人物设定图（四视图/面部三视图） | 脸型、发型、服装 |
| 场景参考（可九宫格） | 空间结构、材质、光线方向 |

### ❌ 不要 / ✅ 要

| ❌ 不要 | ✅ 要 |
|--------|------|
| 堆长文描述左右/枪尖角度 | 火柴人+方框椅子即可；自检「不看文字能否看懂」 |
| 只有草图无人物/场景 | 三者齐传；短文字只补情绪与故事 |
| 四宫格只选脸最好的一张 | **先校验是否看懂草图**；动作构图优先于颜值 |
| 参考图互相矛盾或无关图过多 | 上传前清理；矛盾时 AI 不知以谁为准 |

**流程：** 草图 → 人物四视图 + 场景九宫格 → Image 2.0 / Nano Banana 四宫格候选 → 选构图最接近者再高清放大。
